...
const Nft: React.FC = () => {
  ...
  return (
    <Page title={`NFT - ${t('projectTitle')}`}>
      <div className={getAdaptiveClassName("nft__header", isMobile)}>
        <Container>
          <Header as="h1" content="CosmoMasks" className="shadow" style={{ color: '#ffae00' }} />
        </Container>
      </div>
      <div className={getAdaptiveClassName("nft__section-1", isMobile)}>
        <Container>
      ...
      <div className={getAdaptiveClassName("nft__section-2", isMobile)}>
        <Container>
          <Grid columns="equal" stackable>
            {!isMobile && (
              <Grid.Column>
      ...
      <div className={getAdaptiveClassName("nft__section-3", isMobile)}>
        <Container>
          <Grid columns="equal" stackable>
            <Grid.Column>
              <p>
