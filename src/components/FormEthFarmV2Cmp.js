...
const cmpBsc = '0xB9FDc13F7f747bAEdCc356e9Da13Ab883fFa719B';
const tokenAddress = cmpBsc;

const farmAddress = '0xa190afc03864b49bcb5fa26c0397821cbc0eeff7'; // CMP
const symbol = 'CMP';
const addLiquidityLink = '';
const removeLiquidityLink = '';



function FormEthFarmCmp(props) {
  ...
  const bonusPool = props.data ? props.data['farm2_0x1_cmp'] : {};
  return (
    <Farm
      affectReferralLevel
