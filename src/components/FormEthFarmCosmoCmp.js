...
import { uniswapV2CosmoCmpLpAddress } from '../constants';




const tokenAddress = uniswapV2CosmoCmpLpAddress;

const farmAddress = '0x564d84A9860844Fd572f3914E05385E056F2707c'; // COSMO/CMP
const symbol = 'COSMO/CMP-LP';
const addLiquidityLink = 'https://app.uniswap.org/#/add/v2/0xB9FDc13F7f747bAEdCc356e9Da13Ab883fFa719B/0x27cd7375478F189bdcF55616b088BE03d9c4339c';
const removeLiquidityLink = 'https://app.uniswap.org/#/remove/v2/0xB9FDc13F7f747bAEdCc356e9Da13Ab883fFa719B/0x27cd7375478F189bdcF55616b088BE03d9c4339c';



function FormEthFarmCosmoCmp(props) {
  ...
  const bonusPool = props.data ? props.data['farm_0x1_cosmo_cmp_lp'] : {};
  return (
    <Farm
...
export default connect(mapStateToProps, mapDispatchToProps)(
  hot(module)(FormEthFarmCosmoCmp)
);
