...
const cosmoBsc = '0x60E5FfdE4230985757E5Dd486e33E85AfEfC557b';
const tokenAddress = cosmoBsc;

const farmAddress = '0x9ad31C7ff3cED45E483DcB21029787555DD53AfE'; // COSMO
const symbol = 'COSMO';
...
function FormBscFarmCmp(props) {
  ...
  const bonusPool = props.data ? props.data['farm2_0x38_cosmo'] : {};
  return (
    <Farm
      done={true}
