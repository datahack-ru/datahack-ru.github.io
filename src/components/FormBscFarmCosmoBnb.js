...
const cosmoBnbBsc = '0xAEAb928E54C4ABEAC98bfa08f13a8b15FA53242B';
const tokenAddress = cosmoBnbBsc;

const farmAddress = '0x9AA5C7d6a05A9c4f683E1ceDD10FcE524DcF8fCF'; // COSMO/BNB
const symbol = 'COSMO/BNB-LP';
const addLiquidityLink = '';
const removeLiquidityLink = 'https://v1exchange.pancakeswap.finance/#/remove/0x60E5FfdE4230985757E5Dd486e33E85AfEfC557b/BNB';
...
function FormBscFarmCmp(props) {
  ...
  const bonusPool = props.data ? props.data['farm_0x38_cosmo_bnb_lp'] : {};
  return (
    <Farm
