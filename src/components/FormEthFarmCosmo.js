...
const cosmoBsc = '0x27cd7375478F189bdcF55616b088BE03d9c4339c';
const tokenAddress = cosmoBsc;

const farmAddress = '0x32EFD246e61107A9430f14830e27b9c7798F9332'; // COSMO
const symbol = 'COSMO';
...
function FormEthFarmCosmo(props) {
  ...
  const [farmRate, setFarmRate] = useState('165000');
  ...
  const bonusPool = props.data ? props.data['farm_0x1_cosmo'] : {};
  return (
    <Farm
