...
const cosmoCmpBsc = '0x358754bb5e4Ef38a7cf24B20F2DAEE1ac64f28Cc';
const tokenAddress = cosmoCmpBsc;

const farmAddress = '0xF6712f63788D933813EBD683b9A260f5973A1e09'; // COSMO/CMP
const symbol = 'COSMO/CMP-LP';
const addLiquidityLink = 'https://pancakeswap.finance/add/0x60E5FfdE4230985757E5Dd486e33E85AfEfC557b/0x7A43397662e82a9C15D590f211347D2871B12bb7';
const removeLiquidityLink = 'https://pancakeswap.finance/remove/0x60E5FfdE4230985757E5Dd486e33E85AfEfC557b/0x7A43397662e82a9C15D590f211347D2871B12bb7';
...
function FormBscFarmCmp(props) {
  ...
  const bonusPool = props.data ? props.data['farm2_0x38_cosmo_cmp_lp'] : {};
  return (
    <Farm
      done={true}
