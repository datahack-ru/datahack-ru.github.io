...
const cosmoEthBsc = '0x5269214aeB416eB7769E36DeaFf31EFb28360f21';
const tokenAddress = cosmoEthBsc;

const farmAddress = '0xf80879046f09D1497917FC300d61FF9ae1EF6C8B'; // COSMO/ETH
const symbol = 'COSMO/ETH-LP';
const addLiquidityLink = '';
const removeLiquidityLink = 'https://v1exchange.pancakeswap.finance/#/remove/0x60E5FfdE4230985757E5Dd486e33E85AfEfC557b/0x2170ed0880ac9a755fd29b2688956bd959f933f8';
...
function FormBscFarmCmp(props) {
  ...
  const bonusPool = props.data ? props.data['farm_0x38_cosmo_eth_lp'] : {};
  return (
    <Farm
