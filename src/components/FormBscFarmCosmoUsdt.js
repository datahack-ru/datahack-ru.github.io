...
const cosmoUsdtBsc = '0xa7AbE0c761Fe992060E4ad88564bd8E831453362';
const tokenAddress = cosmoUsdtBsc;

const farmAddress = '0xaceD33Ce0607B4Fe80f75cbc8B2f16e73D791c9c'; // COSMO/USDT
const symbol = 'COSMO/USDT-LP';
const addLiquidityLink = '';
const removeLiquidityLink = 'https://v1exchange.pancakeswap.finance/#/remove/0x60E5FfdE4230985757E5Dd486e33E85AfEfC557b/0x55d398326f99059fF775485246999027B3197955';
...
function FormBscFarmCmp(props) {
  ...
  const bonusPool = props.data ? props.data['farm_0x38_cosmo_usdt_lp'] : {};
  return (
    <Farm
