...
const cmpBsc = '0x7A43397662e82a9C15D590f211347D2871B12bb7';
const tokenAddress = cmpBsc;

const farmAddress = '0x60D3caDd0805b7dDe3ad8f92835f93d4A8D8f839'; // CMP
const symbol = 'CMP';
...
function FormBscFarmCmp(props) {
  ...
  const [farmRate, setFarmRate] = useState('993600000');
  ...
  if (!farmContract) setFarmContract(new ethers.Contract(
    farmAddress, FarmStakingAbi, api.bscProvider
  ));
  ...
  const bonusPool = props.data ? props.data['farm_0x38_cmp'] : {};
  return (
    <Farm
      affectReferralLevel
