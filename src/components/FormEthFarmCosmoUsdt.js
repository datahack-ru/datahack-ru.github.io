...
import { uniswapV2CosmoUsdtLpAddress } from '../constants';



const tokenAddress = uniswapV2CosmoUsdtLpAddress;

const farmAddress = '0x295cf66df2d84623A639Ca298aE29ed9e4793968'; // COSMO/USDT
const symbol = 'COSMO/USDT-LP';
const addLiquidityLink = 'https://app.uniswap.org/#/add/v2/0x27cd7375478F189bdcF55616b088BE03d9c4339c/0xdAC17F958D2ee523a2206206994597C13D831ec7';
const removeLiquidityLink = 'https://app.uniswap.org/#/remove/v2/0x27cd7375478F189bdcF55616b088BE03d9c4339c/0xdAC17F958D2ee523a2206206994597C13D831ec7';



function FormEthFarmCosmoUsdt(props) {
  ...
  const [farmRate, setFarmRate] = useState('1650000');
  ...
  const bonusPool = props.data ? props.data['farm_0x1_cosmo_usdt_lp'] : {};
  return (
    <Farm
...
export default connect(mapStateToProps, mapDispatchToProps)(
  hot(module)(FormEthFarmCosmoUsdt)
);
