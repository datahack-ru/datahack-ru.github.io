...
const cosmoUsdtBsc = '0x5401FE5B9E9C40f1DE67e60bf607FbACa065C43b';
const tokenAddress = cosmoUsdtBsc;

const farmAddress = '0x3D0519d11DBd67a3488cA107e7b63Db56c412860'; // COSMO/USDT
const symbol = 'COSMO/USDT-LP';
const addLiquidityLink = 'https://pancakeswap.finance/add/0x60E5FfdE4230985757E5Dd486e33E85AfEfC557b/0x55d398326f99059fF775485246999027B3197955';
const removeLiquidityLink = 'https://pancakeswap.finance/remove/0x60E5FfdE4230985757E5Dd486e33E85AfEfC557b/0x55d398326f99059fF775485246999027B3197955';
...
function FormBscFarmCmp(props) {
  ...
  const bonusPool = props.data ? props.data['farm2_0x38_cosmo_usdt_lp'] : {};
  return (
    <Farm
      done={true}
